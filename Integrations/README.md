...
Each directory under `Integrations/` owns the deployment-facing adapter and
...
Every executable integration adapter should eventually expose the same minimum
