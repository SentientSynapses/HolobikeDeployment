...
The documents under `schemas/` are the canonical contract (D-15), and they
sit beside this module because a tool's own contract lives beside the tool —
the scope test in `README.md`, applied to the thing that enforces it. This module
